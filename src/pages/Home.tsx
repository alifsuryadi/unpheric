        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="w-full h-96 bg-gradient-to-br from-unpheric-purple/30 to-gray-900 rounded-2xl flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-unpheric-gray">Artist Photo</p>
                </div>
              </div>
          ...
          <div className="about-text space-y-6">
            ...
            <div className="space-y-4 text-unpheric-gray text-lg leading-relaxed">
              <p>
                From the depths of creative exploration to the heights of musical innovation, 
                Unpheric has spent the last six years mastering the art of future bass production. 
                Armed with FL Studio and an insatiable passion for electronic music, this rising 
                artist crafts sonic landscapes that transport listeners to otherworldly realms.
              </p>
              <p>
                Each track is a journey through carefully designed soundscapes, where melodic 
                euphoria meets heavy bass drops, creating an emotional rollercoaster that defines 
                the future bass genre. With influences ranging from cinematic scores to underground 
                electronic movements, Unpheric's music tells stories that resonate with both the 
                heart and the dancefloor.
              </p>
            </div>
          </div>
        </div>
